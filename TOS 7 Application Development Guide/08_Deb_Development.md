...
| `official` | string | ✅ Yes| Official website | Application Support and Help Link. Used to provide a “Get Help” button on the app details page in the App Center. Developers may provide a link to the app’s official website, official forum, GitHub/Gitee repository, help documentation page, or issue reporting/feedback channel. |
